...
def gen_player_stats_sql_template(conn, fk_game_id):
    ...
    #Pepe Laveran Lima Ferreira,Carmo David,Nacho Fernández,Malang Sarr,João Mário,Wendell Nascimento Borges,Jorge Sánchez,Stephen Eustaquio,Marko Grujić,Nico González,Romário Baró,André Franco,Iván Jaime,Alan Varela,Pedro Gonçalves,Wenderson Galeno,Pepê Gabriel Aquino Cossa,Gonçalo Borges,Francisco Conceição,Mehdi Taremi,Francisco Evanilson,Fran Navarro,Zé Luís Andrede,Gabriel Veron,Daniel Namaso Loader
