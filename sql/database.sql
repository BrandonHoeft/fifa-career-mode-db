...
comment on table player_gm_drib is 'each record represents a players dribbling/possession stats in a single league game';
...
comment on table player_gm_shoot is 'each record represents a players shooting stats in a single league game';
...
comment on table player_gm_pass is 'each record represents a players passing stats in a single league game';
...
comment on table player_gm_def is 'each record represents a player defensive stats in a single league game';
